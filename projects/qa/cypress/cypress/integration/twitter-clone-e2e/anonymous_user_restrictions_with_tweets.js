...
describe("Feature: Anonymous user restrictions with tweets", () => {
  beforeEach(() => {
    ...
    /*
      ...
      */
    cy.exec(
      ".\\cypress\\scripts\\import_data_to_mongo.bat twitter-clone-db users .\\cypress\\fixtures\\twitter-clone-e2e\\anonymous_users_restrictions_with_the_tweets\\twitter-clone-db.users.json"
    );

    cy.exec(
      ".\\cypress\\scripts\\import_data_to_mongo.bat twitter-clone-db profiles .\\cypress\\fixtures\\twitter-clone-e2e\\anonymous_users_restrictions_with_the_tweets\\twitter-clone-db.profiles.json"
    );

    cy.exec(
      ".\\cypress\\scripts\\import_data_to_mongo.bat twitter-clone-db tweets .\\cypress\\fixtures\\twitter-clone-e2e\\anonymous_users_restrictions_with_the_tweets\\twitter-clone-db.tweets.json"
    );
