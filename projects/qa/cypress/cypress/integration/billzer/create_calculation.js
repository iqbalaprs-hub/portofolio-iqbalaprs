...
describe("Main page of Billzer: typing data for the Calculation page", () => {
  ...
  it("11.Edge case: User cannot create a Calculation with letters in the Member count input", () => {
    ...
    // BUG 2: A page does not need to be created only for this notification  A tooltip saying "Only groups between 2 and 40 people are allowed." is sufficient
    // BUG 3: Cypress and Chrome works differently. Cypress do NOT write "e" in the member count input. On the contrary, Chrome write write "e" in the member count input
  });
